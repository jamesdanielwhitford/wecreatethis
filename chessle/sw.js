...
// feel), while a background fetch revalidates the cache. Cross-origin
// requests follow network-first without timeout (exact-URL cache keys),
// allowing fallback to cache on network failure.
